...
export class AssemblyInstructionDescriptorTable {
  ...
  public static defineInstructions() {
    ...
    arithmeticInstructions.forEach(([mnemonic, baseOpcode], index) => {
      ...
      const def: InstructionDefinition = {
        ...
        variants: [
          // <base> /r: <mnemonic> r/m8, r8
          {
            ...
            operands: [
              { type: [OperandType.Reg, OperandType.Mem], size: OperandSize.Byte, encoding: OperandEncoding.ModRM_RM },
              { type: OperandType.Reg, size: OperandSize.Byte, encoding: OperandEncoding.ModRM_Reg }
            ]
          },
          // <base+1> /r: <mnemonic> r/m16/32/64, r16/32/64
          {
            ...
            operands: [
              { type: [OperandType.Reg, OperandType.Mem], size: [OperandSize.Word, OperandSize.Dword, OperandSize.Qword], encoding: OperandEncoding.ModRM_RM },
              { type: OperandType.Reg, size: [OperandSize.Word, OperandSize.Dword, OperandSize.Qword], encoding: OperandEncoding.ModRM_Reg }
            ]
          },
          ...
          // <base+4> ib: <mnemonic> AL, imm8
          {
            ...
            fixedImmediateSize: OperandSize.Byte,
            operands: [
              { type: OperandType.Reg, size: OperandSize.Byte, encoding: OperandEncoding.Implicit, isImplicit: true, implicitReg: 'al' },
              { type: OperandType.Imm, size: OperandSize.Byte, encoding: OperandEncoding.Immediate }
            ]
          },
          // <base+5> iw: <mnemonic> AX, imm16
          {
            ...
            immediateType: 'FixedSize',
            fixedImmediateSize: OperandSize.Word,
            implicitRegFamily: 'Accumulator',
            operands: [
              { type: OperandType.Reg, size: OperandSize.Word, encoding: OperandEncoding.Implicit, isImplicit: true },
              { type: OperandType.Imm, size: OperandSize.Word, encoding: OperandEncoding.Immediate }
            ]
          },
          // <base+5> id: <mnemonic> EAX, imm32
          {
            ...
            immediateType: 'FixedSize',
            fixedImmediateSize: OperandSize.Dword,
            implicitRegFamily: 'Accumulator',
            operands: [
              { type: OperandType.Reg, size: OperandSize.Dword, encoding: OperandEncoding.Implicit, isImplicit: true },
              { type: OperandType.Imm, size: OperandSize.Dword, encoding: OperandEncoding.Immediate }
            ]
          },
          // <base+5> id: <mnemonic> RAX, imm32 (sign-extended)
          {
            ...
            implicitRegFamily: 'Accumulator',
            operands: [
              { type: OperandType.Reg, size: OperandSize.Qword, encoding: OperandEncoding.Implicit, isImplicit: true },
              { type: OperandType.Imm, size: OperandSize.Dword, encoding: OperandEncoding.Immediate }
            ]
          },
          ...
          // 81 /<index> iw: <mnemonic> r/m16, imm16
          {
            ...
            fixedImmediateSize: OperandSize.Word,
            operands: [
              { type: [OperandType.Reg, OperandType.Mem], size: OperandSize.Word, encoding: OperandEncoding.ModRM_RM },
              { type: OperandType.Imm, size: OperandSize.Word, encoding: OperandEncoding.Immediate }
            ]
          },
          // 81 /<index> id: <mnemonic> r/m32, imm32
          {
            ...
            fixedImmediateSize: OperandSize.Dword,
            operands: [
              { type: [OperandType.Reg, OperandType.Mem], size: OperandSize.Dword, encoding: OperandEncoding.ModRM_RM },
              { type: OperandType.Imm, size: OperandSize.Dword, encoding: OperandEncoding.Immediate }
            ]
          },
          // 81 /<index> id: <mnemonic> r/m64, imm32 (sign-extended)
          {
            ...
            fixedImmediateSize: OperandSize.Dword,
            operands: [
              { type: [OperandType.Reg, OperandType.Mem], size: OperandSize.Qword, encoding: OperandEncoding.ModRM_RM },
              { type: OperandType.Imm, size: OperandSize.Dword, encoding: OperandEncoding.Immediate }
            ]
          },
      ...
      const movDef: InstructionDefinition = {
        mnemonic: 'MOV',
        variants: [
          // 88 /r: MOV r/m8, r8
          {
          ...
          // B0+rb ib: MOV r8, imm8
          {
            ...
            fixedImmediateSize: OperandSize.Byte,
            operands: [
              { type: OperandType.Reg, size: OperandSize.Byte, encoding: OperandEncoding.OpcodeReg },
              { type: OperandType.Imm, size: OperandSize.Byte, encoding: OperandEncoding.Immediate }
            ]
          },
          // B8+rw iw: MOV r16, imm16
          {
            ...
            fixedImmediateSize: OperandSize.Word,
            operands: [
              { type: OperandType.Reg, size: OperandSize.Word, encoding: OperandEncoding.OpcodeReg },
              { type: OperandType.Imm, size: OperandSize.Word, encoding: OperandEncoding.Immediate }
            ]
          },
          // B8+rd id: MOV r32, imm32
          {
            ...
            fixedImmediateSize: OperandSize.Dword,
            operands: [
              { type: OperandType.Reg, size: OperandSize.Dword, encoding: OperandEncoding.OpcodeReg },
              { type: OperandType.Imm, size: OperandSize.Dword, encoding: OperandEncoding.Immediate }
            ]
          },
          ...
          // This should only be chosen when the immediate is larger than a 32-bit signed value.
          {
            ...
            operationSizeMode: 'ExplicitQword',
            immediateType: 'FixedSize',
            fixedImmediateSize: OperandSize.Qword,
            requiresRexW: true,
            operands: [
              { type: OperandType.Reg, size: OperandSize.Qword, encoding: OperandEncoding.OpcodeReg },
              { type: OperandType.Imm, size: OperandSize.Qword, encoding: OperandEncoding.Immediate }
            ]
          },
      ...
      const leaDef: InstructionDefinition = {
        mnemonic: 'LEA',
        variants: [
          // 8D /r: LEA r16/32/64, m
          {
            ...
            operands: [
              { 
                ...
                size: [OperandSize.Word, OperandSize.Dword, OperandSize.Qword],
                encoding: OperandEncoding.ModRM_Reg
              },
              { 
                ...
                size: [OperandSize.Byte, OperandSize.Word, OperandSize.Dword, OperandSize.Qword],
                encoding: OperandEncoding.ModRM_RM
              }
            ]
          }
        ]
